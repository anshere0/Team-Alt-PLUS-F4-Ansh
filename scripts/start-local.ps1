...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd ai; .\.venv\Scripts\Activate; uvicorn api.main:app --host 0.0.0.0 --port 8001"

Start-Sleep -Seconds 3

Write-Host "Starting Backend on port 8000..."
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd backend; .\.venv\Scripts\Activate; uvicorn app.main:app --host 0.0.0.0 --port 8000"
