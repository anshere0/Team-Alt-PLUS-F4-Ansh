...
async def get_current_user(
    ...
    # Bypass authentication for hackathon demo to prevent 401 Unauthorized 
    # when database is unseeded on Render
    return User(id="mock_admin", username="admin", role=Role.ADMIN)
